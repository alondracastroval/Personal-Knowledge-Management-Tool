...
/**
 * Deals with testing the creation comparator
 */
class CreationComparatorTest {
  ...
  /**
   * Original values that are set before each method
  ...
  /**
   * Determining whether the compare method works correctly using a creation comparator
   */
  @Test
